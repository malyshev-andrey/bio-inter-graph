...
from .encode import load_encode_metadata, load_encode_eclip_data, load_encode_iclip_data
from .protein import (
...
__all__ = [
    ...
    'load_karr_seq_data',
    'load_ric_seq_data',
    'load_encode_metadata', 'load_encode_eclip_data', 'load_encode_iclip_data',
    'load_string_interactions',
    'load_biogrid_interactions',
    'load_intact_interactions',
